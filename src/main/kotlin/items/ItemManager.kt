...
class ItemManager{
    val items = listOf(
        ...
        TrollItem("throwable_fireball", Material.FIRE_CHARGE, "Throwable Fireball", "Right-click to throw a Fireball.", null, TrollRarity.UNFINISHED, "FIREBALL", oneTimeUse = true),
        ...
        TrollItem("pogeroni_sword", Material.NETHERITE_SWORD, "Pogeroni Sword", "Fickt Emanuel.", "Hallo", TrollRarity.RARE, "SWORD", enchantments = mutableMapOf(Enchantment.DAMAGE_ALL to 10, Enchantment.DURABILITY to 5), unbreakable = false)
    )
}